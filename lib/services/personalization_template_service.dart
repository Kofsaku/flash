...
class PersonalizationTemplateService {
  ...
  static const Map<String, List<String>> _categoryMapping = {
    // 中学レベル（13カテゴリー）
    'be_verb': ['emotions', 'daily_habits', 'questions'],
    'general_verb': ['daily_habits', 'past_tense', 'future_plans'],
    ...
    'imperative_exclamatory': ['daily_habits', 'emotions'],
    'there_is_are': ['questions', 'where_question'],
    'progressive': ['daily_habits', 'emotions'],
    'auxiliary_basic': ['emotions', 'future_plans'],
    
    // 高校1年（10カテゴリー）
    'present_perfect': ['past_tense', 'emotions'],
    'infinitive': ['future_plans', 'emotions', 'daily_habits'],
    'gerund': ['daily_habits', 'emotions'],
    'relative_pronouns': ['questions', 'comparison'],
    'participle': ['emotions', 'daily_habits'],
    'auxiliary_advanced': ['emotions', 'future_plans'],
    'conditional_intro': ['future_plans', 'weekend_plan'],
    'conjunction': ['daily_habits', 'comparison'],
    'comparison_structure': ['comparison', 'emotions'],
    ...
    'subjunctive': ['future_plans', 'emotions'],
    'indirect_speech': ['questions', 'daily_habits'],
    'perfect_progressive': ['daily_habits', 'emotions'],
    'participle_construction': ['daily_habits', 'past_tense'],
    'relative_adverbs': ['where_question', 'questions'],
    'appositive_that': ['daily_habits', 'emotions'],
    'indirect_questions': ['questions', 'what_question'],
    'inversion': ['emotions', 'daily_habits'],
    
    // 高校3年（10カテゴリー）
    'subjunctive_advanced': ['future_plans', 'emotions'],
    'complex_sentences': ['daily_habits', 'comparison'],
    'emphasis_inversion': ['emotions', 'comparison'],
    'subjunctive_complete': ['future_plans', 'emotions'],
    'emphasis_structure': ['emotions', 'daily_habits'],
    'ellipsis': ['daily_habits', 'questions'],
    'inanimate_subject': ['daily_habits', 'emotions'],
    'phrasal_expressions': ['daily_habits', 'past_tense'],
    'relative_pronouns_advanced': ['questions', 'comparison'],
    'compound_relatives': ['questions', 'daily_habits'],
    
    // 大学受験・TOEIC（5カテゴリー）
    'vocabulary': ['daily_habits', 'comparison'],
    'complex_structures': ['daily_habits', 'emotions'],
    'business_intro': ['future_plans', 'daily_habits'],
  ...
  static List<ExampleTemplate> getTemplatesForExistingCategory(String existingCategoryId) {
    List<String> templateCategories = _categoryMapping[existingCategoryId] ?? [];
